...
fish_wb_p = readRDS("fish_wb_p.rds")
batt_wb_p = readRDS("batt_wb_p.rds")
fish_s = readRDS("fish_s.rds")
...
if(!dir.exists("./simstore2/")){
    dir.create("./simstore2/")
}
saveRDS(curr_indi,paste0("./simstore2/indi_",str_pad(start_index,5,pad="0"),".rds"))
